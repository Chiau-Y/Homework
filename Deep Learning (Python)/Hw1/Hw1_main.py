...
class CoperQt(QtWidgets.QMainWindow,Ui_MainWindow):
    def __init__(self):
        ...
        self.TrainImage.clicked.connect(self.Train_Image)                         #Q5.1
        self.Hyperparameters.clicked.connect(self.Show_Hyperparameters)           #Q5.2
        self.TrainEpoch.clicked.connect(self.Train_Epoch)                         #Q5.3
        self.TrainingResult.clicked.connect(self.Training_Result)                 #Q5.4
        self.Inference.clicked.connect(self.Inference_)                           #Q5.5
    ...
    def Train_Image(self):                                                        #Q5.1
        Q1_Q5_coding.Trainimage()
    def Show_Hyperparameters(self):                                               #Q5.2
        Q1_Q5_coding.Showhyperparameters()
    def Train_Epoch(self):                                                        #Q5.3
        Q1_Q5_coding.Trainepoch()
    # def Training_Result(self):                                                    #Q5.4 (第一次時跑這個函式)
    #     Q1_Q5_coding.Trainingresult_1()
    def Training_Result(self):                                                    #Q5.4 (第二次後跑這個函式)
        Q1_Q5_coding.Trainingresult_2()
    def Inference_(self):                                                         #Q5.5
        if not self.ImageIndex.text():
            pass
        else :
            y = int(self.ImageIndex.text())
            Q1_Q5_coding.Inference_q(y)
